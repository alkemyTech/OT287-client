...
const EditUserForm = ({
  initialValues, role, onSubmitForm, validationSchema,
  error, errorMessage, handleRole, editSucces, id,
}) => {
  ...
  return (
    <material.Box component="main" sx={{ width: '100%' }}>
      ...
      {location.pathname === '/back-office/users/create'
        ...
        : (
          <material.Typography component="h1" variant="h5" sx={{ fontWeight: 'bold', m: 2 }}>
            Edita el Usuario #
            {' '}
            {id}
            {' '}
